...
export function LandingPage({ onCaseStudies, onContact }) {
  ...
  const heroTopPadding = isSmallMobile ? "8px" : isHeaderGuardMobileViewport ? "36px" : isHeroMobileLayout ? "26px" : isWideTabletGuardViewport ? "14px" : isTabletViewport ? "6px" : "clamp(10px, 2.8vh, 34px)";
  ...
  const heroStatsNudgeY = isSmallMobile ? -40 : isHeroMobileLayout ? -20 : 0;
